# Dev Control Room 0.18.2

Download the Windows amd64 package from [GitHub Releases](https://github.com/knowgyu/dev-control-room/releases).
Version 0.18.2 fixes assurance evidence validity, preserves Worktree targets
across discovery refreshes, and tightens the repository-quality UI flow.
...
```powershell
pwsh -NoProfile -File .\scripts\package.ps1 -Version 0.18.2
```

이 명령은 `docs/RELEASE_NOTES_v0.18.2.md`와
`docs/VERIFICATION_v0.18.2.md`가 모두 있을 때 패키지를 만듭니다. v0.18.2
패키지의 해시는 배포 파일에 포함된 `SHA256SUMS`로 확인합니다.
정확한 지원 범위와 검증 결과는
[`docs/VERIFICATION_v0.18.2.md`](docs/VERIFICATION_v0.18.2.md)에서 확인합니다.
...
- [v0.18.2 릴리즈 노트](docs/RELEASE_NOTES_v0.18.2.md)
- [v0.18.2 검증 기록](docs/VERIFICATION_v0.18.2.md)
...
- [v0.16.0 검증 기록](docs/VERIFICATION_v0.16.0.md)
