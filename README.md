...
```powershell
pwsh -NoProfile -File .\scripts\package.ps1 -Version 0.16.0
```

이 명령은 `docs/RELEASE_NOTES_v0.16.0.md`와
`docs/VERIFICATION_v0.16.0.md`가 모두 있을 때 패키지를 만듭니다.
