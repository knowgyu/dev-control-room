...
function Assert-UIContract {
    ...
    Assert-Condition ($html.Contains('/ui/app.css?v=0.16.0') -and $html.Contains('/ui/app.js?v=0.16.0')) "UI shell version-pins release assets to avoid stale browser caches"
