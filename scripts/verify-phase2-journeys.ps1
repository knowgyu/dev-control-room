...
function Assert-UIContract {
    ...
    Assert-Condition ($html.Contains('/ui/app.css?v=0.15.1') -and $html.Contains('/ui/app.js?v=0.15.1')) "UI shell version-pins release assets to avoid stale browser caches"
