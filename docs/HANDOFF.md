...
## Active: v0.18.2 repository-quality patch release

Status: **RELEASED — automated, browser, package, CI, and remote-asset gates passed**

The v0.18.2 release carries backward-compatible P1 assurance evidence
...
included in the release. Native Windows, browser regression, package, CI, and
release verification for v0.18.2 are recorded in
[`VERIFICATION_v0.18.2.md`](VERIFICATION_v0.18.2.md). The Windows Full gate,
targeted UI CJS suite, Edge 153 browser acceptance, final package gate, and
CI run `34743438251` passed. The release source is
`6e2a52ff1f5886adb95cdc50b39c63c4ddf80719`, published as annotated tag
`v0.18.2`; the release is recorded at
https://github.com/knowgyu/dev-control-room/releases/tag/v0.18.2. The final
Windows amd64 ZIP and `SHA256SUMS` are the only published assets. The release
target remains one Windows amd64 ZIP plus `SHA256SUMS`.
...
## 2026-08-31 v0.15.0 concrete usage guide release

The v0.15.0 implementation candidate `c70074c13c486b68f62c451665e9f73fb1a03402`
replaces the abstract four-step usage slide with a
...
The final source verification record is in
[VERIFICATION_v0.15.0.md](VERIFICATION_v0.15.0.md). The
[v0.15.0 GitHub release](https://github.com/knowgyu/dev-control-room/releases/tag/v0.15.0)
contains only the Windows amd64 ZIP and `SHA256SUMS`; the downloaded archive
matched its checksum and passed extracted-binary browser smoke. CI run
[33323527232](https://github.com/knowgyu/dev-control-room/actions/runs/33323527232)
passed both Windows and Linux jobs. Linux remains CI-only and arm64 remains
cross-build verification-only.
