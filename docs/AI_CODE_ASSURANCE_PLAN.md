...
Status: v0.8.0 implements the bounded local foundation and records native evidence; unfinished exit criteria remain tracked by issue
Updated: 2026-08-26
...
| E — techniques/artifacts | v1 static/security, mutation, property, fuzz, and targeted-E2E adapters; reports; archive/export/cleanup | three-repo fixture creates/verifies/exports/restores artifacts and deletion warning | partial: registered native Go static/property/fuzz/targeted-E2E runners and bounded reports are verified; mutation adapter remains [#5](https://github.com/knowgyu/dev-control-room/issues/5), and restore/retention/quota enforcement remains [#11](https://github.com/knowgyu/dev-control-room/issues/11) |
| F — effects/usage | dashboard, filters, usage ledger, pricing snapshots, exports | fixture produces correctly labelled measured/estimated/unknown effects and stable historical pricing | partial: dashboard, filters, bounded usage/cost, and effect records are accepted; trends/export and full evidence traceability remain [#12](https://github.com/knowgyu/dev-control-room/issues/12) |
