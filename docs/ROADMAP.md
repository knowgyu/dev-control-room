...
| AI-assisted Code Assurance | Milestones A–E accepted for automated scope; Milestone F in progress | docs/AI_CODE_ASSURANCE_PLAN.md and milestone verification documents |
