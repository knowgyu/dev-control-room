...
| AI-assisted Code Assurance | Milestones A–F accepted for automated scope; Milestone G in progress | docs/AI_CODE_ASSURANCE_PLAN.md and milestone verification documents |
